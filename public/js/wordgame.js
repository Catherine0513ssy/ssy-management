...
document.addEventListener('alpine:init', () => {
  Alpine.data('wordGameTab', () => ({
    ...
    studentList: {
      '2313': ['袁微茗','廖芮彤','罗鹏辉','刘雅萱','罗翔译','唐冉','易露熙','万雨彤','吴向荣','龙欣怡','朱笑仪','裴健平','刘瑞','张博彦','段轩禹','向俊涵','曹皓彬','余熙冉','李林颐','王妍熙','樊俊熙','邵善琳','曹怀芳','易铭轩','刘宸熙','张莞淇','陈欣怡','郭子涵','李睿瑶','肖涵杰','曾诗予','王紫贤','唐翌恒','黄镒凌','龙莉','胡芸甄','罗俊涛','黄子皓','陈文杰','罗焕然','侯宇涵','汤卓逸','曾旭洋','龙梓鸣','彭雨萱','罗成辉','莫武羲','苏清泉','刘博鹏','龙妙晴'],
      '2314': ['罗湘妮','刘桐睿','文志远','王雅淇','熊心悦','陈哲诺','段佳辰','王昊','郭睿熙','康紫露','廖梓月','吴歆瑶','尹皓轩','杨可祥','李可乐','龙紫乐','夏欣乐','周子佑','张紫馨','何妍','朱思羽','唐雨朦','陈思宇','龚伊娜','胡子健','王梓瑞','李沛灵','谭轩','胡懿岚','陈梓维','吴芷旋','阳紫晴','杨易','曾嘉一','卢旭林','胡景轩','谢东晟','刘欣薇','张泽洋','刘伊儿','刘子军','杨子昊','罗珈颖','田瑾萱','钟涵宇','陈宇轩','龙奕翔','江梓轩','丁耀阳','袁峻熙']
    },
